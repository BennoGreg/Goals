...
class GoalsFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        recyclerView.adapter = RecyclerAdapter(data) { position: Int -> goalClicked(position) }
        ...
        val swipeHandler = object : SwipeToDeleteCallback(context!!, true) {
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                if (direction == ItemTouchHelper.LEFT) {
                    ...
                    val dialog = AlertDialog.Builder(this@GoalsFragment.context)
                        ...
                        }.setNegativeButton(R.string.no_delete) { _, _ ->
                    ...
                    if (currentProg == data[position].goalFrequency) {
                        val dialogFull = AlertDialog.Builder(this@GoalsFragment.context)
                            .setMessage(resources.getString(R.string.goal_achieved))
                        ...
                        val dialog = AlertDialog.Builder(this@GoalsFragment.context)
                            .setMessage(R.string.askConfirm)
    ...
    private fun goalClicked(position: Int): Boolean {
